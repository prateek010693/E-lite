...
export class AssestInstallComponent implements OnInit, PipeTransform {
  ...
  getExistingWO() {
    ...
    this.workorderService.getExistingWO(this.id).subscribe((data) => {
      ...
      this.assetInstallRemoveForm.controls["assetno"].setValue(
        data.asset_num ? data.asset_num : "N/A"
      );
      this.assetInstallRemoveForm.controls["assetdec"].setValue(
        data.asset_desc ? data.asset_desc : "N/A"
      );
  ...
  iassetSave(index) {
    ...
    this.installForm.controls["lcn"].setValue(
      this.buildItemArray[this.index].lcn
    );
    this.installForm.controls["buildItem"].setValue(
      this.buildItemArray[this.index].buildItem
    );
